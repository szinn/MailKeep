...
pub use priority::{PRIORITY_HEALTH, PRIORITY_INGEST, PRIORITY_NORMAL, PRIORITY_USER};
...
pub mod priority {
    ...
    /// Ingest pipeline work (raw → parse). Same lane as normal pipeline work.
    pub const PRIORITY_INGEST: i16 = 10;
...
mod tests {
    #[test]
    fn priority_ingest_is_ten() {
        assert_eq!(super::PRIORITY_INGEST, 10);
    }
}
