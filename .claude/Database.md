...
- `MAILKEEP__DATABASE__DATABASE_URL` — SeaORM connection string for migrations and entity generation
...
When using the SQLite backend, MailKeep automatically configures these PRAGMAs
